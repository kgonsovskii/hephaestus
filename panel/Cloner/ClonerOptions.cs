...
public sealed class ClonerOptions
{
    ...
    /// <summary>Used on DomainHost only: repo root for <c>install/shared/install-remote.txt</c> when serving <c>/internal/install-remote</c>. Empty = walk up from app base.</summary>
